          ...
          <li key={link.id} className="flex justify-between gap-x-6 py-5">
            <div className="flex gap-x-4">
              <div className="min-w-0 flex-auto">
                <p className="text-md w-40 overflow-hidden truncate font-bold leading-6 sm:w-80">
                  {link.slug}
                </p>
                <p className="mt-1 w-40 overflow-hidden truncate text-xs leading-5 opacity-50 sm:w-80">
                  {link.url}
                </p>
              </div>
            </div>
